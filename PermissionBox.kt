...
fun PermissionBox(
    ...
    PermissionBox(modifier, permissions = listOf(permission), requiredPermissions = listOf(permission), description, contentAlignment,) {
        onGranted() }
}
...
fun PermissionBox(
    ...
    Box(modifier = Modifier.then(modifier),
        ...
        if (allRequiredPermissionsGranted) {
            ...
            PermissionScreen(permissionState, description, errorText, contents = contents)
        }
    }
}
...
private fun PermissionScreen(
    ...
    Column {
        contents.invoke({ if (state.shouldShowRationale) { showRationale = true }
